            ...
            const areaRange = AREA_RANGES[areaIndex]
                        ...
                        <div className="bg-white/90 backdrop-blur-lg p-6 md:p-8 rounded-2xl shadow-2xl border border-white/50 relative z-20 mx-auto -mt-24 max-w-6xl animate-fade-in-up">
                            ...
                            <form onSubmit={handleSearch}>
                                ...
                                <div className={`grid gap-x-4 gap-y-4 items-end ${isProjectSearch ? 'grid-cols-2 md:grid-cols-4 lg:grid-cols-3' : 'grid-cols-2 md:grid-cols-4 lg:grid-cols-5'}`}>
                                    <div className={`col-span-2 ${isProjectSearch ? 'sm:col-span-2' : 'sm:col-span-1'}`}>
                                        <SelectBox
                                            label="Mức giá"
                                            value={priceIndex}
                                    ...
                                    <div className={`col-span-2 ${isProjectSearch ? 'md:col-span-4 lg:col-span-1' : 'md:col-span-4 lg:col-span-1'}`}>
                                        <button
                                            type="submit"
